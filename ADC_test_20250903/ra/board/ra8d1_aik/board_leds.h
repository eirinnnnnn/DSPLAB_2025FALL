...
/*******************************************************************************************************************//**
 * @ingroup BOARD_RA8D1_AIK
 * @defgroup BOARD_RA8D1_AIK_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the RA8D1_PK board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
 **********************************************************************************************************************/
...
{
    BSP_LED_LED1_R = 0,                ///< Red
    BSP_LED_LED1_G = 1,                ///< Green
    BSP_LED_LED1_B = 2,                ///< Blue
} bsp_led_t;
...
/** @} (end defgroup BOARD_RA8D1_AIK_LEDS) */
