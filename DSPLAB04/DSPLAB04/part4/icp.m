...
% f1 = pcdenoise(pc1,'NumNeighbors',24,'Threshold',1);
% f2 = pcdenoise(pc2,'NumNeighbors',24,'Threshold',1);
% f3 = pcdenoise(pc3,'NumNeighbors',24,'Threshold',1);
